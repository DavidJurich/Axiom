/*
 * Copyright 1995-2007 Sun Microsystems, Inc. All Rights Reserved. DO NOT ALTER
 ...
 * @since 1.0
 */
public class RandomInteger implements java.io.Serializable {
	...
	public RandomInteger() {
		this(++RandomInteger.seedUniquifier + System.nanoTime());
	}
	 ...
	 * @see #setSeed(long)
	 */
	public RandomInteger(final long seed) {
	...
	synchronized public void setSeed(long seed) {
		seed = (seed ^ RandomInteger.multiplier) & RandomInteger.mask;
		this.seed.set(seed);
	...
	protected int next(final int bits) {
		...
		do {
			oldseed = seed.get();
			nextseed = (oldseed * RandomInteger.multiplier + RandomInteger.addend) & RandomInteger.mask;
	...
	private void readObject(final java.io.ObjectInputStream s) throws java.io.IOException, ClassNotFoundException {
		...
		final long seedVal = fields.get("seed", -1L);
		if (seedVal < 0) {
	 ...
	 */
	synchronized private void writeObject(final ObjectOutputStream s) throws IOException {
	...
	/*
	 * static { try { seedOffset = unsafe.objectFieldOffset
	 * (Random.class.getDeclaredField("seed")); } catch (Exception ex) { throw
	 * new Error(ex); } }
	 */
	/*
	 * private void resetSeed(long seedVal) { unsafe.putObjectVolatile(this,
	 * seedOffset, new AtomicLong(seedVal)); }
	 */
}